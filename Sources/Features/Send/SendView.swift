...
struct SendView: View {
    ...
    var body: some View {
        ...
        .onChange(of: memo) { _ in
            ...
            // NOTE: FIX M-009 was reverted here — it invalidated preparedTransaction
            // on every keystroke, disabling the Send button and triggering full
            // Groth16 rebuilds. The send path (line ~1155) already checks memo
            // equality and falls through to performSendTransaction() when memo differs.
        }
        .onAppear {
