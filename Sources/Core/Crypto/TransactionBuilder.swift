...
final class TransactionBuilder {
    ...
    func buildShieldedTransaction(
        ...
        // Get spendable notes for the sender
        ...
        // Get anchor from the note's witness
    ...
    private func getSpendableNotes(for address: String, spendingKey: Data) async throws -> [SpendableNote] {
        ...
        let dbNotes = try database.getUnspentNotes(accountId: 0)
        ...
        for dbNote in dbNotes {
            ...
            // Create SpendableNote from database record
            let note = SpendableNote(
                value: dbNote.value,
                anchor: dbNote.witness.prefix(32), // First 32 bytes of witness is anchor
